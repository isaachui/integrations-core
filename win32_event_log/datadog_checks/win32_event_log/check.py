...
class Win32EventLogCheck(AgentCheck):
    ...
    def __init__(self, name, init_config, instances):
        ...
        self._event_priority = self.instance.get(
            'event_priority', self.init_config.get('default_event_priority', 'normal')
        )
    ...
    def construct_query(self):
        ...
        for key, value in filters.items():
            if not isinstance(value, list) and not (isinstance(value, dict) and not value):
